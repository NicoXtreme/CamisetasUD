        ...
        <div class="mx-auto col-lg-6 col-10">
          ...
          <form class="text-left" action="Registrar" method="POST">
            ...
            <div class="form-check">
                <input type="radio" class="form-check-input" id="radio1" name="type" value="cliente">Cliente - Accede al sitio y compra camisetas estampadas.
                <label class="form-check-label" for="radio1"></label>
            </div>
            <div class="form-check">
                <input type="radio" class="form-check-input" id="radio2" name="type" value="artista">Artista - Sube tus estampas, dependiendo del stock que tengas.
